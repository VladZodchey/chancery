...
class Glue:
    ...
    def __init__(
        ...
        Args:
            ...
            anonymous (bool): False to enable read protection and user/role models,
                True to only function as pastes processor
        """
    ...
    @staticmethod
    def hash_password(value: str, salt: bytes) -> bytes:
    ...
    @staticmethod
    def compare_password(true: bytes, suggestion: str) -> bool:
    ...
    def verify_access(self, access_token: str) -> int | None:
    ...
    def verify_api(self, api_token: str) -> int | None:
        """Verifies the validity of an API token.

        Args:
            api_token (str): The API token to check
        Returns:
            int: the bot ID if the token is valid, None otherwise.
